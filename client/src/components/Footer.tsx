          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-center md:text-left">
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/"><a className="text-light-300 hover:text-primary transition-colors">Tea House</a></Link></li>
                <li><Link href="/winners"><a className="text-light-300 hover:text-primary transition-colors">Winners</a></Link></li>
                <li><Link href="/how-it-works"><a className="text-light-300 hover:text-primary transition-colors">How it Works</a></Link></li>
                <li><Link href="/tokenomics"><a className="text-light-300 hover:text-primary transition-colors">Tokenomics</a></Link></li>
                <li><Link href="/roadmap"><a className="text-light-300 hover:text-primary transition-colors">Roadmap</a></Link></li>
              </ul>
            </div>
